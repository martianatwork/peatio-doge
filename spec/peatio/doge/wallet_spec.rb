RSpec.describe Peatio::Doge::Wallet do
  let(:wallet) { Peatio::Doge::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Doge::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Doge::Wallet::SUPPORTED_SETTINGS))
    end
  end
